...
Section:NewButton("Player Tracers [CS]","shows others.", function() 
...
--Admin
local Tab2 = Window:NewTab("Admin")
local Section2 = Tab2:NewSection("Admin idk")
Section2:NewButton("Nameless Admin", "gives you nameless admin without byfron troll screen", function()
...
Section3:NewButton("github Source", "holy shit", function()
